...
const home: Translation['home'] = {
  ...
  viewModes: {
    node: "नोड मैप पर स्विच करें",
    list: "सूची दृश्य पर स्विच करें"
  },
  modals: {
    kokoro: {
      title: "उच्चारण में सुधार करें",
      description: "neko इंटरनेट कनेक्शन की आवश्यकता के बिना, अधिक स्वाभाविक अंग्रेजी उच्चारण देने के लिए एक उन्नत आवाज मॉडल (Kokoro TTS) का उपयोग कर सकता है।",
